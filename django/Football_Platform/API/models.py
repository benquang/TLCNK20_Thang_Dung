...
class FbrefMatchgoalsModified(models.Model):
    ...
    minute = models.FloatField(db_column='Minute', blank=True, null=True)  # Field name made lowercase.
    ...
    type_of_goal = models.CharField(db_column='Type_Of_Goal', max_length=100, db_collation='utf8mb3_general_ci', blank=True, null=True)  # Field name made lowercase.
